    ...
    <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="sm:col-span-2">
            <a href="#" class="inline-flex items-center">
                ...
                <span class="ml-2 text-xl font-bold tracking-wide text-gray-800">Farmspot</span>
            </a>
            <div class="mt-6 lg:max-w-xl">
                <p class="text-sm text-gray-800">
                Farmspot is an innovative platform designed to connect farmers directly with consumers. By doing so, we aim to eliminate middlemen, ensuring that farmers receive fair prices for their hard work while consumers enjoy better deals.
                    </p>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="flex">
                ...
                <a href="#" title="send email">farmspot@company.com</a>
            </div>
        </div>
